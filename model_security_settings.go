...
// GetClusterPublicKey returns the ClusterPublicKey field value
...
// GetClusterPublicKeyOk returns a tuple with the ClusterPublicKey field value
...
// SetClusterPublicKey sets field value
...
// GetDataRecoveryPasswordConfigured returns the DataRecoveryPasswordConfigured field value
...
// GetDataRecoveryPasswordConfiguredOk returns a tuple with the DataRecoveryPasswordConfigured field value
// and a boolean to check if the value has been set.
...
// SetDataRecoveryPasswordConfigured sets field value
...
// GetMessageSecurityStatus returns the MessageSecurityStatus field value
...
// GetMessageSecurityStatusOk returns a tuple with the MessageSecurityStatus field value
// and a boolean to check if the value has been set.
...
// SetMessageSecurityStatus sets field value
func (o *SecuritySettings) SetMessageSecurityStatus(v string) {
	o.MessageSecurityStatus = v
}

// GetReAuthSecureTunnelAfterInterruption returns the ReAuthSecureTunnelAfterInterruption field value
...
// GetReAuthSecureTunnelAfterInterruptionOk returns a tuple with the ReAuthSecureTunnelAfterInterruption field value
// and a boolean to check if the value has been set.
...
// SetReAuthSecureTunnelAfterInterruption sets field value
