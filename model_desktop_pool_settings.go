...
// GetDeleteInProgress returns the DeleteInProgress field value
...
// GetDeleteInProgressOk returns a tuple with the DeleteInProgress field value
// and a boolean to check if the value has been set.
...
// SetDeleteInProgress sets field value
