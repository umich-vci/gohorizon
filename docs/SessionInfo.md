...
**ApplicationNames** | **[]string** | Names of the applications launched in the session.  It will be only set when session_type is APPLICATION. | [optional] 
...
**DisconnectedTime** | **int64** | Epoch time in milli seconds, when the session was last disconnected.  This will be unset if the session&#39;s machine has an error state, or if the session has never been disconnected. | [optional] 
...
**SecurityGatewayData** | [**SecurityGatewayData**](SecurityGatewayData.md) |  | [optional] 
